...
public class Jogo {
    ...
    public void moverPeca(int origemX, int origemY, int destinoX, int destinoY) {
        ...
        if (casaBloqueadaOrigem == null) {
            ...
            if ((getVez() == 1 && (peca.getCorPeca() == CorPeca.BRANCA || peca.getCorPeca() == CorPeca.BRANCA)) ||
                (getVez() == 2 && (peca.getCorPeca() == CorPeca.VERMELHA || peca.getCorPeca() == CorPeca.VERMELHA))) {
                ...
                if (peca.isMovimentoValido(destino)) {
                    ...
                    if (simularMovimentoEValidar(origem, destino)) {                    
                        ...
                        jogadas++;
                        if (peca.podeTransformarParaDama(destino)) peca.transfomarEmDama(destino);
                    }
                }
            }
        } else {
    ...
    //         ((peca.getCorPeca() == CorPeca.BRANCA) || (peca.getCorPeca() == CorPeca.VERMELHA))) {
    ...
    //             if (peca.getCorPeca() == CorPeca.VERMELHA) {
    //                 if ((distanciaX == 1 || distanciaY == 1) && (distanciaX == distanciaY) && sentidoY == -1) {
    //                     return true;
    //                 } else {
    //                     return false;
    ...
    //             if ((peca.getCorPeca() == CorPeca.BRANCA || peca.getCorPeca() == CorPeca.BRANCA) && (pecaAlvo.getCorPeca() == CorPeca.BRANCA || pecaAlvo.getCorPeca() == CorPeca.BRANCA)) {
    //                 if (pecasAComer.size() > 0) pecasAComer.removeAll(pecasAComer);
    //                 return false;
    //             }

    //             if ((peca.getCorPeca() == CorPeca.VERMELHA || peca.getCorPeca() == CorPeca.VERMELHA) && (pecaAlvo.getCorPeca() == CorPeca.VERMELHA || pecaAlvo.getCorPeca() == CorPeca.VERMELHA)) {
    //                 if (pecasAComer.size() > 0) pecasAComer.removeAll(pecasAComer);
    //                 return false;
    //             }
    ...
    private boolean simularMovimentoEValidar(Casa origem, Casa destino){
        ...
        return peca.ehMovimentoValido(tabuleiro, origem, destino, pecasAComer);
    }
        ...
        if ((peca.isPedra())) {
            ...
            try {
                ...
                if (!( pecaAtual == null)) {
                    ...
                    if(peca.ehDaMesmaCor(pecaAtual)){
                        return false;
                    }
    ...
    //     if (casa.getPeca().getCorPeca() == CorPeca.BRANCA) {
    //         if (casa.getY() == 7) return true;
    //     }
        
    //     // REGRA PARA PEÇAS VERMELHAS
    //     if (casa.getPeca().getCorPeca() == CorPeca.VERMELHA) {
    ...
    //     if (pedra.getCorPeca() == CorPeca.BRANCA) {
    //         Dama dama = new Dama(casa, CorPeca.BRANCA);
    //         pedra = (Dama) dama;
    //     } else {
    //         Dama dama = new Dama(casa, CorPeca.VERMELHA);
    //         pedra = (Dama) dama;
    //     }
    // }
    ...
    public void colocarPecas(Tabuleiro tabuleiro) {
        ...
        for (int x = 0; x < 8; x++) {
            for (int y = 5; y < 8; y++) {
                if ((x % 2 != 0) && (y % 2 != 0)) {
                    Casa casa = tabuleiro.getCasa(x, y);
                    new Pedra(casa, CorPeca.VERMELHA);
                }
                else if ((x % 2 == 0) && (y % 2 == 0)) {
                    Casa casa = tabuleiro.getCasa(x, y);
                    new Pedra(casa,CorPeca.VERMELHA);
    ...
    public int getPontosJogadorUm(){
        return jogadorUm.getPontos();
    }
    
    public int getPontosJogadorDois(){
        return jogadorDois.getPontos();
    }

    public int getCasaBloqueadaY() {
        return casaBloqueadaOrigem.getY();
    }
    public int getCasaBloqueadaX() {
        return casaBloqueadaOrigem.getX();
    }
