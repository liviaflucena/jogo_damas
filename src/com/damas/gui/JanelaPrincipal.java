...
import com.damas.objetos.StatusJogo;
...
public class JanelaPrincipal extends JFrame {
    ...
    public JanelaPrincipal() {
        ...
        criarNovoJogo();
        this.statusJogo = new StatusJogo(jogo);
        ...
        menuStatus.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {JOptionPane.showMessageDialog(null, statusJogo.gerarStatus());}
        });
